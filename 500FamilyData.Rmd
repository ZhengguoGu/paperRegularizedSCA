...
```{r}
family_data <- list("mom" = DS3_Mom_Final[, -c(1:3)], "dad" = DS3_Dad_Final[, -c(1:3)], "child" = DS4_Kid[, -c(1:3)])
...
save(family_data, file = "D:/Dropbox/Tilburg office/Research SCA/Project 2 software Simultaneous/newdata/family_data.RData") 
```